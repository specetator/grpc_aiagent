// 简单的前端工具：提供 MD5(hash) 与统一的登录/注册请求封装。
// 说明：仅用于 demo，真实生产环境请使用 HTTPS + 更安全的密码学方案（如 bcrypt/scrypt/argon2）

/* eslint-disable */
// 经典 MD5 实现（压缩版），来源于社区常用实现，做了轻微格式整理。
